        ...
        <Table sx={{ minWidth: 650 }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">مجموع هزینه</TableCell>
          ...
          <TableBody>
            {basket.items.map(item => (
              ...
              >
                ...
                <TableCell align="right">تومان{item.price}</TableCell>
                ...
                <TableCell align="right">تومان{item.price*item.quantity}</TableCell>
