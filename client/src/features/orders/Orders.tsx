...
export default function Orders() {
    ...
    if (loading) return <LoadingComponent message="...در حال دریافت سفارشات" />
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="right">جمع نهایی</TableCell>
                ...
                <TableBody>
                    {orders?.map((order) => (
                        ...
                        >
                            ...
                            <TableCell align="right">تومان{order.total}</TableCell>
